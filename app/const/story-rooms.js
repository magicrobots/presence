...
export default {
    ...
    rooms: [
        ...
        },
        {
            ...
            x: 46,
            y: 47,
            summary: 'on the green grass next to the sparkling pond',
        ...
        },
        {
            ...
            x: 46,
            y: 48,
            summary: 'in the calming shade of the forest',
        ...
        },
        {
            ...
            x: 48,
            y: 48,
            summary: 'surrounded by endless stacks of computer servers',
        ...
        },
        {
            ...
            x: 48,
            y: 46,
            summary: 'squinting at the tinny echoes in the commercial kitchen',
        ...
        },
        {
            ...
            exits: {
                ...
                W: {
                    closed: null,
                    opened: 'The hallway continues to the west.'
                   },
                S: null
            }
        },
        {
            ...
            exits: {
                ...
                E: {
                    closed: null,
                    opened: 'Eastward stretches a poorly lit antiseptic looking hallway. Signage indicates a "LABORATORY".'
                   },
                W: {
        ...
        },
        {
            ...
            x: 49,
            y: 48,
            summary: 'waiting for your eyes to adjust in the thick darkness of the sewers',
        ...
        },
        {
            ...
            x: 50,
            y: 48,
            summary: 'picking your way across the tracks in the subway tunnel',
        ...
        },
        {
            ...
            x: 45,
            y: 48,
            summary: 'feeling the soft breeze in the warm beauty of the meadow',
        ...
        },
        {
            ...
            x: 51,
            y: 46,
            summary: 'trying not to step on anything important in the clutter of the laboratory',
            ...
            exits: {
                ...
                W: {
                    closed: null,
                    opened: 'To the west is a poorly lit hallway.'
                   },
                S: {
        ...
        },
        {
            ...
            x: 51,
            y: 47,
            summary: 'admiring the impossible perfection of the cube shaped room',
        ...
        },
        {
            ...
            completed: {
                ...
                illuminated: 'The darkness of the tunnel is still dark even with your flashlight glinting off the rocky walls.'
            },
            exits: {
                N: null,
                E: {
        ...
        },
        {
            ...
            x: 52,
            y: 46,
            summary: 'in the strange room that reminds you of a giant\'s kitchen',
        ...
        },
        {
            ...
            x: 53,
            y: 46,
            summary: 'in the center of the command deck, feeling tiny amid the rotating holographic projections of the stars around you',
            ...
            completed: 'In the command deck, you pretend you\'re in Star Trek for a minute. It would be more fun with some friends. AHEAD WARP ZILLION!',
            isInSpace: true,
            exits: {
                N: {
                    closed: null,
        ...
        },
        {
            ...
            x: 54,
            y: 46,
            summary: 'in what you think are the alien\'s sleeping quarters',
        ...
        },
        {
            ...
            x: 53,
            y: 47,
            summary: 'making your way through the unfathomable complexity of the engine room',
        ...
        },
        {
            ...
            x: 53,
            y: 45,
            summary: 'back in the cockpit, feeling insignificant - confronted through the windows by the vast emptiness of space',
        ...
        },
        {
            ...
            x: 52,
            y: 49,
            summary: 'in a cavern, the scuffs of your feet echoing off the invisible, distant walls',
            description: {
